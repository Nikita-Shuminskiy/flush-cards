...
import { AppInitStateType, changeModeModal } from '../../../Store/Reducers/AppReducer';
...
export const PacksList = React.memo(() => {
    ...
    const onSubmit = () => dispatch(changeModeModal('add'))
    const pageClickChange = (page: number) => dispatch(getUserThunk(page, pageCount))
    return (
